...
The AI Gateway exposes an OpenAI-compatible API on port 4000. Any application that works with the OpenAI API can connect to the gateway by changing the base URL and API key -- no other code changes required.
